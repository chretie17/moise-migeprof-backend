...
const { registerFamily, updateFamily, deleteFamily, addAttendance, getFamilies, getPrograms, getFamiliesByProgram, getallFamilies } = require('../controllers/familyController'); 
